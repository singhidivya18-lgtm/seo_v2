 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M=globalThis,ee=r=>r,L=M.trustedTypes,te=L?L.createPolicy("lit-html",{createHTML:r=>r}):void 0,ce="$lit$",b=`lit$${Math.random().toFixed(9).slice(2)}$`,de="?"+b,Ae=`<${de}>`,$=document,O=()=>$.createComment(""),R=r=>r===null||typeof r!="object"&&typeof r!="function",J=Array.isArray,Se=r=>J(r)||typeof(r==null?void 0:r[Symbol.iterator])=="function",D=`[ 	
\f\r]`,C=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ie=/-->/g,se=/>/g,y=RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),re=/'/g,oe=/"/g,he=/^(?:script|style|textarea|title)$/i,ke=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),h=ke(1),S=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),ne=new WeakMap,v=$.createTreeWalker($,129);function ue(r,e){if(!J(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return te!==void 0?te.createHTML(e):e}const Ee=(r,e)=>{const t=r.length-1,i=[];let s,o=e===2?"<svg>":e===3?"<math>":"",n=C;for(let l=0;l<t;l++){const a=r[l];let d,u,p=-1,g=0;for(;g<a.length&&(n.lastIndex=g,u=n.exec(a),u!==null);)g=n.lastIndex,n===C?u[1]==="!--"?n=ie:u[1]!==void 0?n=se:u[2]!==void 0?(he.test(u[2])&&(s=RegExp("</"+u[2],"g")),n=y):u[3]!==void 0&&(n=y):n===y?u[0]===">"?(n=s??C,p=-1):u[1]===void 0?p=-2:(p=n.lastIndex-u[2].length,d=u[1],n=u[3]===void 0?y:u[3]==='"'?oe:re):n===oe||n===re?n=y:n===ie||n===se?n=C:(n=y,s=void 0);const m=n===y&&r[l+1].startsWith("/>")?" ":"";o+=n===C?a+Ae:p>=0?(i.push(d),a.slice(0,p)+ce+a.slice(p)+b+m):a+b+(p===-2?l:m)}return[ue(r,o+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class U{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let o=0,n=0;const l=e.length-1,a=this.parts,[d,u]=Ee(e,t);if(this.el=U.createElement(d,i),v.currentNode=this.el.content,t===2||t===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(s=v.nextNode())!==null&&a.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(const p of s.getAttributeNames())if(p.endsWith(ce)){const g=u[n++],m=s.getAttribute(p).split(b),j=/([.?@])?(.*)/.exec(g);a.push({type:1,index:o,name:j[2],strings:m,ctor:j[1]==="."?Te:j[1]==="?"?Pe:j[1]==="@"?Me:B}),s.removeAttribute(p)}else p.startsWith(b)&&(a.push({type:6,index:o}),s.removeAttribute(p));if(he.test(s.tagName)){const p=s.textContent.split(b),g=p.length-1;if(g>0){s.textContent=L?L.emptyScript:"";for(let m=0;m<g;m++)s.append(p[m],O()),v.nextNode(),a.push({type:2,index:++o});s.append(p[g],O())}}}else if(s.nodeType===8)if(s.data===de)a.push({type:2,index:o});else{let p=-1;for(;(p=s.data.indexOf(b,p+1))!==-1;)a.push({type:7,index:o}),p+=b.length-1}o++}}static createElement(e,t){const i=$.createElement("template");return i.innerHTML=e,i}}function k(r,e,t=r,i){var n,l;if(e===S)return e;let s=i!==void 0?(n=t._$Co)==null?void 0:n[i]:t._$Cl;const o=R(e)?void 0:e._$litDirective$;return(s==null?void 0:s.constructor)!==o&&((l=s==null?void 0:s._$AO)==null||l.call(s,!1),o===void 0?s=void 0:(s=new o(r),s._$AT(r,t,i)),i!==void 0?(t._$Co??(t._$Co=[]))[i]=s:t._$Cl=s),s!==void 0&&(e=k(r,s._$AS(r,e.values),s,i)),e}class Ce{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=((e==null?void 0:e.creationScope)??$).importNode(t,!0);v.currentNode=s;let o=v.nextNode(),n=0,l=0,a=i[0];for(;a!==void 0;){if(n===a.index){let d;a.type===2?d=new I(o,o.nextSibling,this,e):a.type===1?d=new a.ctor(o,a.name,a.strings,this,e):a.type===6&&(d=new ze(o,this,e)),this._$AV.push(d),a=i[++l]}n!==(a==null?void 0:a.index)&&(o=v.nextNode(),n++)}return v.currentNode=$,s}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class I{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=k(this,e,t),R(e)?e===c||e==null||e===""?(this._$AH!==c&&this._$AR(),this._$AH=c):e!==this._$AH&&e!==S&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Se(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==c&&R(this._$AH)?this._$AA.nextSibling.data=e:this.T($.createTextNode(e)),this._$AH=e}$(e){var o;const{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=U.createElement(ue(i.h,i.h[0]),this.options)),i);if(((o=this._$AH)==null?void 0:o._$AD)===s)this._$AH.p(t);else{const n=new Ce(s,this),l=n.u(this.options);n.p(t),this.T(l),this._$AH=n}}_$AC(e){let t=ne.get(e.strings);return t===void 0&&ne.set(e.strings,t=new U(e)),t}k(e){J(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const o of e)s===t.length?t.push(i=new I(this.O(O()),this.O(O()),this,this.options)):i=t[s],i._$AI(o),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,t);e!==this._$AB;){const s=ee(e).nextSibling;ee(e).remove(),e=s}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class B{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,o){this.type=1,this._$AH=c,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=c}_$AI(e,t=this,i,s){const o=this.strings;let n=!1;if(o===void 0)e=k(this,e,t,0),n=!R(e)||e!==this._$AH&&e!==S,n&&(this._$AH=e);else{const l=e;let a,d;for(e=o[0],a=0;a<o.length-1;a++)d=k(this,l[i+a],t,a),d===S&&(d=this._$AH[a]),n||(n=!R(d)||d!==this._$AH[a]),d===c?e=c:e!==c&&(e+=(d??"")+o[a+1]),this._$AH[a]=d}n&&!s&&this.j(e)}j(e){e===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Te extends B{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===c?void 0:e}}class Pe extends B{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==c)}}class Me extends B{constructor(e,t,i,s,o){super(e,t,i,s,o),this.type=5}_$AI(e,t=this){if((e=k(this,e,t,0)??c)===S)return;const i=this._$AH,s=e===c&&i!==c||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,o=e!==c&&(i===c||s);s&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}}class ze{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){k(this,e)}}const q=M.litHtmlPolyfillSupport;q==null||q(U,I),(M.litHtmlVersions??(M.litHtmlVersions=[])).push("3.3.3");const Oe=(r,e,t)=>{const i=(t==null?void 0:t.renderBefore)??e;let s=i._$litPart$;if(s===void 0){const o=(t==null?void 0:t.renderBefore)??null;i._$litPart$=s=new I(e.insertBefore(O(),o),o,void 0,t??{})}return s._$AI(r),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`)};try{const o=await fetch("/api/action",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({userAction:{name:r,context:s}})}),n=await o.json().catch(()=>({}));if(!o.ok||n.ok===!1)throw new Error(n.error||"The request could not be started.");await this._refresh()}catch(o){r==="curate_titles"&&(this._curationPending=!1),this._requestError=o instanceof Error?o.message:"The request could not be started."}}async _cancelJob(){try{await fetch("/api/cancel",{method:"POST"}),await this._refresh()}catch{}}_statusClass(){return this._job.state==="error"?"status-error":this._job.state==="complete"?"status-success":this._busy?"status-busy":"status-idle"}_renderResultStatus(r){const e=Be.exec(r||"");return e?h`
      ...
      `:h`<span class="result-error">${(r||"No result").replace(/^x\s*/,"")}</span>`}_renderCategories(){return h`
    ...
    `}_renderIdeas(){return h`
      ...
      <div class="ideas-list">
        ${this._category.titles.map((r,e)=>h`
              ...
              <div class="result-main">
                ...
                ${r.linkedin_post?h`
                  <details class="social-details">
                    ...
                    <div class="social-content">${r.linkedin_post}</div>
                  </details>
                `:c}
                ${r.twitter_thread?h`
                  <details class="social-details">
                    <summary>Twitter/X Thread</summary>
                    <div class="social-content">${r.twitter_thread}</div>
                  </details>
                `:c}
                ${r.image_url?h`
    ...
    `}render(){const r=this._titleList.length,e=this._loading?"Connecting":this._busy?"Working":this._job.state==="complete"?"Complete":"Ready";return h`
      <div class="page">
